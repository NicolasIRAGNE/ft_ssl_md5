...
#    Updated: 2019/09/10 12:03:44 by niragne          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	main.c opts.c opts_2.c process_md5.c process_sha256.c swap.c debug.c md5_loops.c\
		rotate.c open_file.c ssl_perror.c tools.c sha256_tools.c process_sha224.c\
		process_sha512.c sha512_tools.c process_sha384.c
