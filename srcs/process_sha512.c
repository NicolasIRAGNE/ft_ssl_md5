...
/*   Updated: 2019/09/10 11:43:33 by niragne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
S0 := (a rightrotate64 28) xor (a rightrotate64 34) xor (a rightrotate64 39)
S1 := (e rightrotate64 14) xor (e rightrotate64 18) xor (e rightrotate64 41)

s0 := (w[i-15] rightrotate64 1) xor (w[i-15] rightrotate64 8) xor (w[i-15] rightshift 7)
s1 := (w[i-2] rightrotate64 19) xor (w[i-2] rightrotate64 61) xor (w[i-2] rightshift 6)
*/
...
void			sha512_print_result(char *s, t_ssl_wrapper *wrapper)
{
	...
	ft_printf("%016lx%016lx%016lx%016lx%016lx%016lx%016lx%016lx", sha->h0, sha->h1, sha->h2,
