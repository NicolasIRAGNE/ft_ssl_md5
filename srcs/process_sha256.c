...
/*   Updated: 2019/09/10 13:34:08 by niragne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		get_padded_message(char *s, t_ssl_wrapper *wrapper)
{
	...
	formatted_len = align(original_len + sizeof(uint64_t) + 1, 64);
...
void			sha256_print_result(char *s, t_ssl_wrapper *wrapper)
{
	...
	ft_printf("%08x%08x%08x%08x%08x%08x%08x%08x", sha->h0, sha->h1, sha->h2,
